...
![Java 内存模型1](https://oss.link/markdown/hexo_java_thread_memory1.png)
...
![Java 内存模型2](https://oss.link/markdown/hexo_java_thread_memory2.png)

![Java 内存模型3](https://oss.link/markdown/hexo_java_thread_memory3.png)
