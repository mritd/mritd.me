...
**有能力的童鞋可以使用梯子，我已经下载好了一个 [点击下载](https://cdn.oss.link/files/docker-compose)**；下载后直接 cp 到 `/usr/local/bin` 下并给与可执行权限即可。
...
![hexo_docker_harbor_prepare](https://cdn.oss.link/markdown/hexo_docker_harbor_prepare.png)
...
![hexo_docker_harbor_up](https://cdn.oss.link/markdown/hexo_docker_harbor_up.png)
...
![hexo_docker_harbor_contianer](https://cdn.oss.link/markdown/hexo_docker_harbor_contianer.png)
...
![hexo_docker_harbor_homepage](https://cdn.oss.link/markdown/hexo_docker_harbor_homepage.png)
...
![hexo_docker_harbor_userspace](https://cdn.oss.link/markdown/hexo_docker_harbor_userspace.png)

### 4.3、创建私有项目

**Harbor 有一个项目的概念，项目名可以理解为 Docker Hub 的用户名，其下可以后很多 images，Harbor 的项目必须登录后方可 push，公有项目和私有项目的区别是对其他用户是否可见**

![hexo_docker_harbor_createproject](https://cdn.oss.link/markdown/hexo_docker_harbor_createproject.png)
...
![hexo_docker_harbor_composeerror](https://cdn.oss.link/markdown/hexo_docker_harbor_composeerror.jpeg)
...
![hexo_docker_harbor_projectuser](https://cdn.oss.link/markdown/hexo_docker_harbor_projectuser.png)

![hexo_docker_harbor_projectuserrole](https://cdn.oss.link/markdown/hexo_docker_harbor_projectuserrole.png)
...
![hexo_docker_harbor_loginmritd](https://cdn.oss.link/markdown/hexo_docker_harbor_loginmritd.png)

然后 `tag` 一个 image，名称一定要标准( `registryAddress[:端口]/项目/imageName[:tag]` )，最后将其 push 即可

![hexo_docker_harbor_pushmritdimages](https://cdn.oss.link/markdown/hexo_docker_harbor_pushmritdimages.png)

最后可在 Web UI 中查看刚刚 push 的 image

![hexo_docker_harbor_mritdshow](https://cdn.oss.link/markdown/hexo_docker_harbor_mritdshow.png)
