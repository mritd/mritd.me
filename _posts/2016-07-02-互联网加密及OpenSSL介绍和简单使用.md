...
![hexo_openssl_shenfenrenzheng1](https://mritd.oss.link/markdown/hexo_openssl_shenfenrenzheng1.png)
...
![hexo_openssl_shenfenrenzheng2](https://mritd.oss.link/markdown/hexo_openssl_shenfenrenzheng2.png)
...
![hexo_openssl_DH](https://mritd.oss.link/markdown/hexo_openssl_DH.png)
...
![hexo_openssl_datawanzheng](https://mritd.oss.link/markdown/hexo_openssl_datawanzheng.png)
...
![hexo_openssl_dirtree](https://mritd.oss.link/markdown/hexo_openssl_dirtree.png)
...
![hexo_openssl_createcapb](https://mritd.oss.link/markdown/hexo_openssl_createcapb.png)

**最后要创建用于签名证书的相关文件，**执行 `touch demoCA/{index.txt,serial,crlnumber}` 创建所需文件，执行 `echo "01" > demoCA/serial` 初始化序列号，最终文件目录结构如下

![hexo_openssl_createcafiledirtree](https://mritd.oss.link/markdown/hexo_openssl_createcafiledirtree.png)
...
![hexo_openssl_createprivatekey](https://mritd.oss.link/markdown/hexo_openssl_createprivatekey.png)
...
![hexo_openssl_signedcrt](https://mritd.oss.link/markdown/hexo_openssl_signedcrt.png)
