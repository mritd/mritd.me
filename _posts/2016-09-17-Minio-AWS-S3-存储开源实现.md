...
![hexo_minio_homepage](http://cdn.mritd.me/markdown/hexo_minio_homepage.png)

同时在启动 minio 后默认会输出当前 minio 服务器的相关登录参数，如 access_key 等，nohup 启动则默认重定向到了 nohup.out 文件中，如下所示

![hexo_minio_token](http://cdn.mritd.me/markdown/hexo_minio_token.png)
...
![hexo_minio_token](http://cdn.mritd.me/markdown/hexo_minio_create_bucket.png)
