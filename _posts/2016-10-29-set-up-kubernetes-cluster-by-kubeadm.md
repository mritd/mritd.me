...
![release](https://oss.link/markdown/3zs7u.jpg)

![rpm目录](https://oss.link/markdown/8b3a4.jpg)
...
![docker-libray](https://oss.link/markdown/2eo34.jpg)

其中每个 Dockerfile 只需要 `FROM` 一下即可

![Dockerfile](https://oss.link/markdown/cxva2.jpg)

**最后在 Docker Hub 上创建自动构建项目**

![createproject](https://oss.link/markdown/p5khs.jpg)

![from github](https://oss.link/markdown/gc8vl.jpg)

![selectproject](https://oss.link/markdown/9ufnd.jpg)

![details](https://oss.link/markdown/ud42y.jpg)

**最后要手动触发一下，然后 Docker Hub 才会开始给你编译**

![Tigger](https://oss.link/markdown/phgsg.jpg)

**等待完成即可直接 pull 了**

![success](https://oss.link/markdown/itnw3.jpg)
...
![all json](https://oss.link/markdown/3ovg8.jpg)

![image version](https://oss.link/markdown/uitnd.jpg)
...
![init master](https://oss.link/markdown/rs2mw.jpg)
...
![join master](https://oss.link/markdown/9c8eu.jpg)

![get node](https://oss.link/markdown/ri4q9.jpg)

#### 3.6、部署 weave 网络

再没部署 weave 时，dns 是启动不了的，如下

![dns not work](https://oss.link/markdown/fqjsg.jpg)
...
![create weave](https://oss.link/markdown/0ja5f.jpg)
...
![IfNotPresent](https://oss.link/markdown/lqvh1.jpg)
...
![create dashboard](https://oss.link/markdown/xsn9u.jpg)

**通过 describe 命令我们可以查看其暴露出的 `NodePoint`,然后便可访问**

![describe dashboard](https://oss.link/markdown/5a94q.jpg)

![show dashboard](https://oss.link/markdown/xwjvs.jpg)
...
![modify kube-dns](https://oss.link/markdown/hhozt.jpg)
