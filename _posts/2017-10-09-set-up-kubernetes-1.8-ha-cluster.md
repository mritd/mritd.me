...
![Gen Etcd Cert](https://cdn.oss.link/markdown/6mn6y.jpg)
...
![check etcd](https://cdn.oss.link/markdown/ecrgr.jpg)
...
![Master Success](https://cdn.oss.link/markdown/klnwa.jpg)
...
![cluster success](https://cdn.oss.link/markdown/c4dde.jpg)
...
![Node Ready](https://cdn.oss.link/markdown/agxp3.jpg)
...
![Test Calico](https://cdn.oss.link/markdown/00krx.jpg)
...
![DNS](https://cdn.oss.link/markdown/vg95n.jpg)

然后创建两组 Pod 和 Service，进入 Pod 中 curl 另一个 Service 名称看看是否能解析；同时还要测试一下外网能否解析

![Test DNS1](https://cdn.oss.link/markdown/x185c.jpg)

测试外网

![Test DNS2](https://cdn.oss.link/markdown/3k9gz.jpg)
...
![DNS autoscaler](https://cdn.oss.link/markdown/mid1u.jpg)
