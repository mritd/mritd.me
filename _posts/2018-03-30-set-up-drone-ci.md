...
![create drone app](https://oss.link/markdown/lzm4j.png)

创建 Application 时请自行更换回调地址域名，创建好后如下所示(后续 Drone CI 需要使用这两个 key)

![drone app create success](https://oss.link/markdown/sl4yl.png)
...
![drone ci project list](https://oss.link/markdown/6u4fk.png)
...
![drone test project](https://oss.link/markdown/ybrjc.png)
...
![drone user token](https://oss.link/markdown/5fkvi.png)
...
![Drone Project Trusted Setting](https://oss.link/markdown/gd60v.png)
